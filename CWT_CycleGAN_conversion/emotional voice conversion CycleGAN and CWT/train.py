...
def train(train_A_dir, train_B_dir, model_dir, model_name, random_seed, validation_A_dir, validation_B_dir, output_dir, tensorboard_log_dir):
    ...
    num_epochs = 100 # WAS 5000
    mini_batch_size = 50 # mini_batch_size = 1 is better
    generator_learning_rate = 0.0002
    generator_learning_rate_decay = generator_learning_rate / 200000
    discriminator_learning_rate = 0.00001 # WAS 0.0001
        ...
        if validation_A_dir is not None:
            if epoch % 50 == 0:
                ...
                for file in os.listdir(validation_A_dir):
                    if "desktop.ini" in file:  # Skip the desktop.ini file
                        continue
                    ...
                    sf.write(os.path.join(validation_A_output_dir, os.path.basename(file)), wav_transformed, sampling_rate)
